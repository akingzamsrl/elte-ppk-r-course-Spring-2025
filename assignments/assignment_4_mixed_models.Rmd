...
# Fix incorrect sex coding (e.g., lowercase or typos)
data_A$sex <- factor(tolower(data_A$sex), levels = c("female", "male"))

# Check for cortisol values less than zero and fix
data_A$cortisol_serum[data_A$cortisol_serum < 0] <- NA
data_A$cortisol_saliva[data_A$cortisol_saliva < 0] <- NA
